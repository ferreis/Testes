...
public class TaskInfo {
    ...
    public static String inferSkillFromType(String taskType) {
        switch (taskType.toLowerCase()) {
            case "build": case "construct": case "carpentry": case "masonry":
                return "construction";
            case "mine": case "mining":
                return "mining";
            case "woodcut": case "woodcutting":
                return "woodcutting";
            case "smith": case "smithing": case "forge":
                return "smithing";
            case "farm": case "farming":
                return "farming";
            default:
                return "general";
        }
